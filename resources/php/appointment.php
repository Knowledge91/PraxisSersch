...
$toemails[] = array(
				'email' => 'info@praxis-sersch.de', // Your Email Address
				'name' => 'Praxis Sersch' // Your Name
			);

// Form Processing Messages
$message_success = 'Wir haben Ihre Email <strong>erhalten</strong> und melden uns so schnell wie möglich.';
...
//		$dob = isset($dob) ? "Date of Birth: $dob<br><br>" : '';
		$date = isset($date) ? "Datum: $date<br><br>" : '';
//		$second_booking = isset($second_booking) ? "Second Booking: $second_booking<br><br>" : '';
		...
		$body = "$name $phone $email  $date  $message $referrer";
